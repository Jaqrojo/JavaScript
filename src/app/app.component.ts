...
export class AppComponent  {
  ...
  */
  variable='';
  guardarvalorenvariable(valor)
  {this.variable=valor;}
  MostarMensajeEnVariable = true;
  ngOnInit()
  {
  ...
  queMensajeMostrar()
  {
    if (this.MostarMensajeEnVariable==true)
    {
      this.guardarvalorenvariable ("True");
    }
    else
    { this.guardarvalorenvariable("false")}
  }
}
